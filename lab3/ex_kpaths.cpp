...
public:
  kPaths_Instance(Digraph &graph,DiNodeName &vvname,
		  DiNodePos &posx,DiNodePos &posy,
		  ArcWeight &eweight,
		  DiNode &source, DiNode &target,
		  int k);
  Digraph &g;
  DiNodeName &vname;
  DiNodePos &px;
...
kPaths_Instance::kPaths_Instance(Digraph &graph,DiNodeName &vvname,
				 DiNodePos &posx,DiNodePos &posy,
				 ArcWeight &eweight,
				 DiNode &nsource,
				 DiNode &ntarget,
